...
class _CurvePainterState extends State<CurvePainter> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _widthAnimation = Tween<double>(begin: 0, end: widget.size.width)
        .animate(CurvedAnimation(parent: _controller, curve: Curves.fastOutSlowIn));
    _curveAnimation =
        Tween<double>(begin: 0, end: 2 * pi).animate(CurvedAnimation(parent: _controller, curve: Curves.fastOutSlowIn));
    _controller.forward();
  }
