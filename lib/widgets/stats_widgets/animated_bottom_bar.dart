...
class AnimatedBottomBar extends StatefulWidget {
  ...
  AnimatedBottomBar(
      {this.barItems, this.animationDuration = const Duration(milliseconds: 500), this.elevation, this.onItemTap, this.currBarItem});
...
class AnimatedBarItem extends StatefulWidget {
  ...
  AnimatedBarItem(
      {this.isSelected, this.thisItemIndex, this.barItem, this.currBarItem, this.animationDuration, this.elevation, this.onItemTap});
  @override
