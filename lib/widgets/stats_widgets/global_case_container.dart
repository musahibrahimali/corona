                ...
                children: <Widget>[
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: _caseType == CaseType.ACTIVE
                            ? const Color(0xfff3cfff) //Color(0xffffd9b5)
                            : Colors.white,
                  ...
                  InkWell(
                    ...
                    child: AnimatedContainer(
                      ...
                      curve: caseTypeCurve,
                      decoration: BoxDecoration(
                          color: _caseType == CaseType.DEATHS ? const Color(0xffffcfcc) : Colors.white,
                          borderRadius: BorderRadius.circular(10)),
                      padding: EdgeInsets.symmetric(
                        horizontal: MediaQuery.of(context).size.width > 360.0
                            ? 16
                  ...
                  Expanded(
                    child: InkWell(
                      ...
                      child: AnimatedContainer(
                        ...
                        duration: caseTypeDuration,
                        decoration: BoxDecoration(
                            color: _caseType == CaseType.RECOVERED ? const Color(0xffdbffe5) : Colors.white,
                            borderRadius: BorderRadius.circular(10)),
                        padding: EdgeInsets.symmetric(
                          vertical: 12,
