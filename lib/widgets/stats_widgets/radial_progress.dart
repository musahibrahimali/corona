...
class _RadialProgressState extends State<RadialProgress> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _radialController = AnimationController(vsync: this, duration: fillDuration); //1.5s
    _radialAnimation =
        Tween(begin: 0.0, end: 360.0).animate(CurvedAnimation(parent: _radialController, curve: Curves.fastOutSlowIn))
          ..addListener(() {
      ...
      builder: (context, child) => SizedBox(
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Positioned.fill(
              child: Align(
                alignment: Alignment(cos((2 * pi * progressDegrees / 360.0) - (pi / 2)),
...
class RadialPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(rect, math.radians(-90), math.radians(degrees!), false, progressPaint);
  }
