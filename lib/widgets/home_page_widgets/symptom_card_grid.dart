...
class SymptomCardGrid extends StatefulWidget {
  const SymptomCardGrid({Key? key}) : super(key: key);
...
class _SymptomCardGridState extends State<SymptomCardGrid> {
  ...
  final List<Map<String, String>> symptoms = const [
    {
      "symptom": "Fever",
      "desc": "A temperature that's higher than normal.\nTypically around 98.6°F (37°C)",
      "imgPath": "assets/symptoms/high_fever.png",
    },
    {
      "symptom": "Sore Throat",
      "desc": "A sore throat is a painful, dry, or scratchy feeling in the throat.",
    ...
    {
      "symptom": "Fatigue",
      "desc": "You have no energy, no motivation and overall feeling of tiredeness.",
    ...
    },
    {
      ...
      "desc": "You feel shortness of breath and a tight sensation in your chest",
      "imgPath": "assets/symptoms/sore_throat.png",
    },
  ];
